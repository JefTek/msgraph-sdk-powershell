...
### Publish (Default)
```
Publish-MgDriveListContentTypeBase -ContentTypeId <String> -DriveId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgDriveListContentTypeBase -InputObject <IFilesIdentity> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
