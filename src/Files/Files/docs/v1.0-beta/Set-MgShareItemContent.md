...
### Set (Default)
```
Set-MgShareItemContent -DriveItemId <String> -SharedDriveItemId <String> -InFile <String>
 [-BodyParameter <Stream>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgShareItemContent -InputObject <IFilesIdentity> -InFile <String> [-BodyParameter <Stream>] [-PassThru]
