...
### Get (Default)
```
Get-MgShareListContentTypeColumnSourceColumnByRef -ColumnDefinitionId <String> -ContentTypeId <String>
 -SharedDriveItemId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgShareListContentTypeColumnSourceColumnByRef -InputObject <IFilesIdentity> [<CommonParameters>]
```
