...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/update-mguserauthenticationpasswordmethod
schema: 2.0.0
---
...
Update-MgUserAuthenticationPasswordMethod -PasswordAuthenticationMethodId <String> -UserId <String>
 ...
 [-Id <String>] [-Password <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgUserAuthenticationPasswordMethod -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphPasswordAuthenticationMethod> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### -CreationDateTime
The date and time when this password was last updated.
