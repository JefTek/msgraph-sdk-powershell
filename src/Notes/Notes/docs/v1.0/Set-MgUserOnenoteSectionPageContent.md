...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/set-mguseronenotesectionpagecontent
schema: 2.0.0
---
...
### SetViaIdentity1
```
Set-MgUserOnenoteSectionPageContent -InputObject <INotesIdentity> -InFile <String> [-BodyParameter <Stream>]
