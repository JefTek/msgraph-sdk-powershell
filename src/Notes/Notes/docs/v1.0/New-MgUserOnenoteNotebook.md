...
### Create
```
New-MgUserOnenoteNotebook -UserId <String> -BodyParameter <IMicrosoftGraphNotebook> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserOnenoteNotebook -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook> [-Confirm]
