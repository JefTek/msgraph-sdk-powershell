...
### Set (Default)
```
Set-MgUserOnenotePageContent -OnenotePageId <String> -UserId <String> -InFile <String>
 [-BodyParameter <Stream>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgUserOnenotePageContent -InputObject <INotesIdentity> -InFile <String> [-BodyParameter <Stream>]
