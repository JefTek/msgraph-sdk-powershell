...
### Create
```
New-MgSiteOnenoteNotebook -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteOnenoteNotebook -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook> [-Confirm]
