...
### Get1 (Default)
```
Get-MgGroupOnenotePageContent -GroupId <String> -OnenotePageId <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenotePageContent -InputObject <INotesIdentity> -OutFile <String> [-PassThru] [<CommonParameters>]
```
