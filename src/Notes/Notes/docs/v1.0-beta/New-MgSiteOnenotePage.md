...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/new-mgsiteonenotepage
schema: 2.0.0
---
...
New-MgSiteOnenotePage -SiteId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
 ...
 [-ParentNotebook <IMicrosoftGraphNotebook1>] [-ParentSection <IMicrosoftGraphOnenoteSection1>]
 [-Self <String>] [-Title <String>] [-UserTags <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create1
```
New-MgSiteOnenotePage -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgSiteOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-Confirm]
