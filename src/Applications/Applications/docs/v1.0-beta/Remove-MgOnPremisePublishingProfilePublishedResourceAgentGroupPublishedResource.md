...
Remove-MgOnPremisePublishingProfilePublishedResourceAgentGroupPublishedResource
 ...
 -PublishedResourceId1 <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgOnPremisePublishingProfilePublishedResourceAgentGroupPublishedResource
 -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
