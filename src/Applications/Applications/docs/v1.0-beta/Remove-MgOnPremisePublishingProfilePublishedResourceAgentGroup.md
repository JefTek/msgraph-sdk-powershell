...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/remove-mgonpremisepublishingprofilepublishedresourceagentgroup
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgOnPremisePublishingProfilePublishedResourceAgentGroup -OnPremisesAgentGroupId <String>
...
### DeleteViaIdentity
```
Remove-MgOnPremisePublishingProfilePublishedResourceAgentGroup -InputObject <IApplicationsIdentity>
