...
```
Update-MgDeviceAppMgtDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
...
### UpdateViaIdentity1
```
Update-MgDeviceAppMgtDefaultManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
