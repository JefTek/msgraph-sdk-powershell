...
### Delete1 (Default)
```
Remove-MgDeviceAppMgtManagedAppRegistrationOperation -ManagedAppOperationId <String>
 -ManagedAppRegistrationId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-MgDeviceAppMgtManagedAppRegistrationOperation -InputObject <IDevicesCorporateManagementIdentity>
