...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmgtiosmanagedappprotectiondeploymentsummary
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceAppMgtiOSManagedAppProtectionDeploymentSummary -IosManagedAppProtectionId <String>
