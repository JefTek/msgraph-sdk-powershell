...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmgtdefaultmanagedappprotectionapp
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceAppMgtDefaultManagedAppProtectionApp -DefaultManagedAppProtectionId <String>
 -ManagedMobileAppId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceAppMgtDefaultManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
