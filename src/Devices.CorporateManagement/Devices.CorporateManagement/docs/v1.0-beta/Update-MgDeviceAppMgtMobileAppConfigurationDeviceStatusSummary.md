...
```
Update-MgDeviceAppMgtMobileAppConfigurationDeviceStatusSummary -ManagedDeviceMobileAppConfigurationId <String>
 -BodyParameter <IMicrosoftGraphManagedDeviceMobileAppConfigurationDeviceSummary> [-PassThru] [-Confirm]
...
Update-MgDeviceAppMgtMobileAppConfigurationDeviceStatusSummary
 ...
 [-NotApplicablePlatformCount <Int32>] [-PendingCount <Int32>] [-SuccessCount <Int32>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
