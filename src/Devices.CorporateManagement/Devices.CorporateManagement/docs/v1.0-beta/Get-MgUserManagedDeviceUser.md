...
### Get
```
Get-MgUserManagedDeviceUser -ManagedDeviceId <String> -UserId <String> -UserId1 <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserManagedDeviceUser -InputObject <IDevicesCorporateManagementIdentity> [-ExpandProperty <String[]>]
