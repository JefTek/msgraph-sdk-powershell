...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/new-mgdeviceappmgtiosmanagedappprotectionapp
schema: 2.0.0
---
...
```
New-MgDeviceAppMgtiOSManagedAppProtectionApp -IosManagedAppProtectionId <String>
...
### CreateViaIdentity1
```
New-MgDeviceAppMgtiOSManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
 -BodyParameter <IMicrosoftGraphManagedMobileApp> [-Confirm] [-WhatIf] [<CommonParameters>]
```
