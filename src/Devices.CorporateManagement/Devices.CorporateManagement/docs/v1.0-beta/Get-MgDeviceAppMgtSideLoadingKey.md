...
### List (Default)
```
Get-MgDeviceAppMgtSideLoadingKey [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgDeviceAppMgtSideLoadingKey -SideLoadingKeyId <String> [-ExpandProperty <String[]>]
