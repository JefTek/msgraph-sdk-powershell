...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmgtandroidmanagedappprotectionapp
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceAppMgtAndroidManagedAppProtectionApp -AndroidManagedAppProtectionId <String>
 -ManagedMobileAppId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceAppMgtAndroidManagedAppProtectionApp -InputObject <IDevicesCorporateManagementIdentity>
