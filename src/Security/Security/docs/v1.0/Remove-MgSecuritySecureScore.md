...
### Delete1 (Default)
```
Remove-MgSecuritySecureScore -SecureScoreId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity1
```
Remove-MgSecuritySecureScore -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
