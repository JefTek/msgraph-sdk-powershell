...
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String> -RoleDefinitionId <String>
 ...
 [-ResourceScopes <String[]>] [-RoleDefinition <IMicrosoftGraphRoleDefinition>] [-PassThru] [-Confirm]
...
```
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <String> -RoleDefinitionId <String>
 -BodyParameter <IMicrosoftGraphRoleAssignment1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
