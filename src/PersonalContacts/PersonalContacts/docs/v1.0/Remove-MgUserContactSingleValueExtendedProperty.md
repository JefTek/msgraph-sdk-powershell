...
### Delete (Default)
```
Remove-MgUserContactSingleValueExtendedProperty -ContactId <String>
...
### DeleteViaIdentity
```
Remove-MgUserContactSingleValueExtendedProperty -InputObject <IPersonalContactsIdentity> [-IfMatch <String>]
