...
### Get (Default)
```
Get-MgReportTeamUserActivityTotalCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamUserActivityTotalCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
