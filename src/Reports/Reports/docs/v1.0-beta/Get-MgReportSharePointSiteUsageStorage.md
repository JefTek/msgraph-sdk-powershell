...
### Get1 (Default)
```
Get-MgReportSharePointSiteUsageStorage -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportSharePointSiteUsageStorage -InputObject <IReportsIdentity> [<CommonParameters>]
```
