...
### Get (Default)
```
Get-MgReportYammerGroupActivityDetailDa9A -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerGroupActivityDetailDa9A -InputObject <IReportsIdentity> [<CommonParameters>]
```
