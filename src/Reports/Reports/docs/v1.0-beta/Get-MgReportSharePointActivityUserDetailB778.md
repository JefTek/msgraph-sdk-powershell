...
### Get1 (Default)
```
Get-MgReportSharePointActivityUserDetailB778 -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportSharePointActivityUserDetailB778 -InputObject <IReportsIdentity> [<CommonParameters>]
```
