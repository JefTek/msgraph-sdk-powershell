...
### Get (Default)
```
Get-MgReportYammerDeviceUsageUserDetailCfad -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerDeviceUsageUserDetailCfad -InputObject <IReportsIdentity> [<CommonParameters>]
```
