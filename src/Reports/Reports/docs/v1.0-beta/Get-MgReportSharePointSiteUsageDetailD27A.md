...
### Get1 (Default)
```
Get-MgReportSharePointSiteUsageDetailD27A -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportSharePointSiteUsageDetailD27A -InputObject <IReportsIdentity> [<CommonParameters>]
```
