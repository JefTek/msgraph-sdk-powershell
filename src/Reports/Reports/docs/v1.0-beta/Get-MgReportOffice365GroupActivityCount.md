...
### Get1 (Default)
```
Get-MgReportOffice365GroupActivityCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365GroupActivityCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
