...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportazureadfeatureusage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgReportAzureAdFeatureUsage -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportAzureAdFeatureUsage -InputObject <IReportsIdentity> [<CommonParameters>]
```
