...
### Get1 (Default)
```
Get-MgReportSharePointSiteUsageSiteCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportSharePointSiteUsageSiteCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
