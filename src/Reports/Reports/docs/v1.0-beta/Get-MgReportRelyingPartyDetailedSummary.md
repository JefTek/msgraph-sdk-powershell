...
### Get (Default)
```
Get-MgReportRelyingPartyDetailedSummary -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportRelyingPartyDetailedSummary -InputObject <IReportsIdentity> [<CommonParameters>]
```
