...
### Get1 (Default)
```
Get-MgReportOneDriveUsageAccountDetailE827 -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveUsageAccountDetailE827 -InputObject <IReportsIdentity> [<CommonParameters>]
```
