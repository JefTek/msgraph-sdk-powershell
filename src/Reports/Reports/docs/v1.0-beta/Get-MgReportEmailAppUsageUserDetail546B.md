...
### Get1 (Default)
```
Get-MgReportEmailAppUsageUserDetail546B -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportEmailAppUsageUserDetail546B -InputObject <IReportsIdentity> [<CommonParameters>]
```
