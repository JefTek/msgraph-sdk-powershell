...
### Get (Default)
```
Get-MgReportTeamUserActivityDistributionTotalUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamUserActivityDistributionTotalUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
