...
### Get1 (Default)
```
Get-MgReportOffice365ActiveUserDetailD389 -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365ActiveUserDetailD389 -InputObject <IReportsIdentity> [<CommonParameters>]
```
