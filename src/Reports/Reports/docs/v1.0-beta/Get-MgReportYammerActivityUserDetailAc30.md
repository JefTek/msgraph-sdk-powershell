...
### Get (Default)
```
Get-MgReportYammerActivityUserDetailAc30 -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerActivityUserDetailAc30 -InputObject <IReportsIdentity> [<CommonParameters>]
```
