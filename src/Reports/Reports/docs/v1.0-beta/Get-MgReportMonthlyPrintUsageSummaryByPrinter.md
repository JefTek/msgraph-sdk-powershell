...
### List (Default)
```
Get-MgReportMonthlyPrintUsageSummaryByPrinter [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgReportMonthlyPrintUsageSummaryByPrinter -PrintUsageByPrinterId <String> [-ExpandProperty <String[]>]
