...
### Get1 (Default)
```
Get-MgReportOffice365ServiceUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365ServiceUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
