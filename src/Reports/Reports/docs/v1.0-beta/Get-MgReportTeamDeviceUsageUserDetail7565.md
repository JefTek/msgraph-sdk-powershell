...
### Get (Default)
```
Get-MgReportTeamDeviceUsageUserDetail7565 -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamDeviceUsageUserDetail7565 -InputObject <IReportsIdentity> [<CommonParameters>]
```
