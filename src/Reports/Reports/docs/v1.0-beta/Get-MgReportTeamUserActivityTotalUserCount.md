...
### Get (Default)
```
Get-MgReportTeamUserActivityTotalUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamUserActivityTotalUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
