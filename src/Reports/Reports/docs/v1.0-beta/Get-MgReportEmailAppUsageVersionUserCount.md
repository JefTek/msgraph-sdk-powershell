...
### Get1 (Default)
```
Get-MgReportEmailAppUsageVersionUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportEmailAppUsageVersionUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
