...
### Get1 (Default)
```
Get-MgReportOneDriveActivityFileCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveActivityFileCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
