...
### Get (Default)
```
Get-MgReportTeamDeviceUsageTotalUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamDeviceUsageTotalUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
