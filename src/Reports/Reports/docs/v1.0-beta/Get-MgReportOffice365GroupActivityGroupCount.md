...
### Get1 (Default)
```
Get-MgReportOffice365GroupActivityGroupCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365GroupActivityGroupCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
