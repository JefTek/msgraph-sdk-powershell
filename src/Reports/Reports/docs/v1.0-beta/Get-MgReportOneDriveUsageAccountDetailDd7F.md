...
### Get1 (Default)
```
Get-MgReportOneDriveUsageAccountDetailDd7F -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveUsageAccountDetailDd7F -InputObject <IReportsIdentity> [<CommonParameters>]
```
