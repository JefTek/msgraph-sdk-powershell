...
### Get1 (Default)
```
Get-MgReportOneDriveActivityUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveActivityUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
