...
### Managed (Default)
```
Get-MgReportManagedDeviceEnrollmentFailureDetail2B3D -Filter <String> -Skip <Int32> -SkipToken <String>
 -Top <Int32> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### ManagedViaIdentity
```
Get-MgReportManagedDeviceEnrollmentFailureDetail2B3D -InputObject <IReportsIdentity> -OutFile <String>
