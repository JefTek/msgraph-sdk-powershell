...
### Get1 (Default)
```
Get-MgReportEmailActivityUserDetailDdb2 -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportEmailActivityUserDetailDdb2 -InputObject <IReportsIdentity> [<CommonParameters>]
```
