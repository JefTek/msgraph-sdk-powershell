...
### Get1 (Default)
```
Get-MgReportOneDriveActivityUserDetailC424 -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveActivityUserDetailC424 -InputObject <IReportsIdentity> [<CommonParameters>]
```
