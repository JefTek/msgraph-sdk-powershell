...
### Get1 (Default)
```
Get-MgReportSharePointSiteUsageFileCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportSharePointSiteUsageFileCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
