...
### Get (Default)
```
Get-MgReportYammerActivityUserDetail15A5 -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerActivityUserDetail15A5 -InputObject <IReportsIdentity> [<CommonParameters>]
```
