...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportm365appuserdetail2b20
schema: 2.0.0
---

# Get-MgReportM365AppUserDetail2B20
...
### Get (Default)
```
Get-MgReportM365AppUserDetail2B20 -Date <DateTime> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportM365AppUserDetail2B20 -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
