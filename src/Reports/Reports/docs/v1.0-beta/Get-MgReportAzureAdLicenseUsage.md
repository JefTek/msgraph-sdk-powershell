...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportazureadlicenseusage
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgReportAzureAdLicenseUsage -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportAzureAdLicenseUsage -InputObject <IReportsIdentity> [<CommonParameters>]
```
