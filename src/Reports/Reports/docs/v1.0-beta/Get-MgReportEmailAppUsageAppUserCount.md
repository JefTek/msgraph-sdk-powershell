...
### Get1 (Default)
```
Get-MgReportEmailAppUsageAppUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportEmailAppUsageAppUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
