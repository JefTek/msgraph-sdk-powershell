...
### Get (Default)
```
Get-MgReportYammerGroupActivityGroupCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerGroupActivityGroupCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
