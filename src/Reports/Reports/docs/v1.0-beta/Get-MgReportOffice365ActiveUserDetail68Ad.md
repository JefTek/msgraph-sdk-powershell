...
### Get1 (Default)
```
Get-MgReportOffice365ActiveUserDetail68Ad -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOffice365ActiveUserDetail68Ad -InputObject <IReportsIdentity> [<CommonParameters>]
```
