...
### Get (Default)
```
Get-MgReportTeamUserActivityUserCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamUserActivityUserCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
