...
### Get (Default)
```
Get-MgReportYammerGroupActivityDetail0D7D -Period <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerGroupActivityDetail0D7D -InputObject <IReportsIdentity> [<CommonParameters>]
```
