...
### Get (Default)
```
Get-MgReportYammerDeviceUsageUserDetailD0Ac -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportYammerDeviceUsageUserDetailD0Ac -InputObject <IReportsIdentity> [<CommonParameters>]
```
