...
### Get1 (Default)
```
Get-MgReportOneDriveUsageAccountCount -Period <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveUsageAccountCount -InputObject <IReportsIdentity> [<CommonParameters>]
```
