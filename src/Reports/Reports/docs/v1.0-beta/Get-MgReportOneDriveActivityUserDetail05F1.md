...
### Get1 (Default)
```
Get-MgReportOneDriveActivityUserDetail05F1 -Date <DateTime> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportOneDriveActivityUserDetail05F1 -InputObject <IReportsIdentity> [<CommonParameters>]
```
