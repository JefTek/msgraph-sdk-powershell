...
### Get (Default)
```
Get-MgReportOffice365GroupActivityDetail81Cc -Date <DateTime> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportOffice365GroupActivityDetail81Cc -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
