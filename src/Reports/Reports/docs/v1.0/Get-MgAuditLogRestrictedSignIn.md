...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgauditlogrestrictedsignin
schema: 2.0.0
---
...
### List (Default)
```
Get-MgAuditLogRestrictedSignIn [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgAuditLogRestrictedSignIn -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
