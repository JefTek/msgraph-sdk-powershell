...
### Get (Default)
```
Get-MgReportSharePointActivityUserDetailF3Be -Date <DateTime> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportSharePointActivityUserDetailF3Be -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
