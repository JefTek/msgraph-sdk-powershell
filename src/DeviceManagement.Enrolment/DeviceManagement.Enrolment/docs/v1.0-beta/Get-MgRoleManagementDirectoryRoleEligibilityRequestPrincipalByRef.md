...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleeligibilityrequestprincipalbyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleEligibilityRequestPrincipalByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleEligibilityRequestPrincipalByRef -UnifiedRoleEligibilityRequestId <String>
 [<CommonParameters>]
```
