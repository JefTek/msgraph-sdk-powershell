...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/invoke-mgfilterrolemanagemententitlementmanagementroleeligibilityrequest
schema: 2.0.0
---

# Invoke-MgFilterRoleManagementEntitlementManagementRoleEligibilityRequest
...
### Filter (Default)
```
Invoke-MgFilterRoleManagementEntitlementManagementRoleEligibilityRequest -On <String> [<CommonParameters>]
```
