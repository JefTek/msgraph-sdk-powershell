...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentscheduleactivatedusingbyref
schema: 2.0.0
---
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm]
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleId <String> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
