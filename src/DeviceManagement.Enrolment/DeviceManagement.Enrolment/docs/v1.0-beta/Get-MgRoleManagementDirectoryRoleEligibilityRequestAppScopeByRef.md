...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleeligibilityrequestappscopebyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleEligibilityRequestAppScopeByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleEligibilityRequestAppScopeByRef -UnifiedRoleEligibilityRequestId <String>
 [<CommonParameters>]
```
