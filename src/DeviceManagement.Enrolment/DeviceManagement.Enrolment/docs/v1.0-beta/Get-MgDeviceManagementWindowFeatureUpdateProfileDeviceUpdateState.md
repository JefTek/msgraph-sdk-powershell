...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgdevicemanagementwindowfeatureupdateprofiledeviceupdatestate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementWindowFeatureUpdateProfileDeviceUpdateState -WindowsFeatureUpdateProfileId <String>
...
```
Get-MgDeviceManagementWindowFeatureUpdateProfileDeviceUpdateState -WindowsFeatureUpdateProfileId <String>
 -WindowsUpdateStateId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
