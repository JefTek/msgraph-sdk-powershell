...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestappscopebyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestAppScopeByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestAppScopeByRef -UnifiedRoleAssignmentRequestId <String>
 [<CommonParameters>]
```
