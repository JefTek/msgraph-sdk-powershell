...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleeligibilityrequestdirectoryscope
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleEligibilityRequestDirectoryScope
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleEligibilityRequestDirectoryScope -UnifiedRoleEligibilityRequestId <String>
