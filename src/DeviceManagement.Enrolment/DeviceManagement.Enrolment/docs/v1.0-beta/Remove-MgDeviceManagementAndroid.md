...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgdevicemanagementandroid
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceManagementAndroid -AndroidForWorkEnrollmentProfileId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceManagementAndroid -InputObject <IDeviceManagementEnrolmentIdentity> [-IfMatch <String>]
