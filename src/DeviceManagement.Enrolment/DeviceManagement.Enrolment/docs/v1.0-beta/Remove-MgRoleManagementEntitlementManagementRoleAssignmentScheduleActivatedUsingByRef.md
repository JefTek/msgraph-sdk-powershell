...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagemententitlementmanagementroleassignmentscheduleactivatedusingbyref
schema: 2.0.0
---
...
```
Remove-MgRoleManagementEntitlementManagementRoleAssignmentScheduleActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
