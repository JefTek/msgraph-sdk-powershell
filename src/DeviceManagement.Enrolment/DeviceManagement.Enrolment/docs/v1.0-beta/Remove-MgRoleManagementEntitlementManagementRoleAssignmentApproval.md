...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagemententitlementmanagementroleassignmentapproval
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgRoleManagementEntitlementManagementRoleAssignmentApproval -ApprovalId <String> [-IfMatch <String>]
