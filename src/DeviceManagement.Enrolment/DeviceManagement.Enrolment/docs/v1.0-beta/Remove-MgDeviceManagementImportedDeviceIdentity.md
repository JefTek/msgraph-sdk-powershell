...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgdevicemanagementimporteddeviceidentity
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceManagementImportedDeviceIdentity -ImportedDeviceIdentityId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDeviceManagementImportedDeviceIdentity -InputObject <IDeviceManagementEnrolmentIdentity>
