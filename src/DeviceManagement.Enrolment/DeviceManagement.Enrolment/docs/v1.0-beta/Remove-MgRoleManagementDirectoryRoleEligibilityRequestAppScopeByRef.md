...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectoryroleeligibilityrequestappscopebyref
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryRoleEligibilityRequestAppScopeByRef
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryRoleEligibilityRequestAppScopeByRef -UnifiedRoleEligibilityRequestId <String>
