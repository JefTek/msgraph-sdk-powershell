...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/new-mgrolemanagemententitlementmanagementroleassignmentrequest
schema: 2.0.0
---

# New-MgRoleManagementEntitlementManagementRoleAssignmentRequest
...
```
New-MgRoleManagementEntitlementManagementRoleAssignmentRequest [-Action <String>]
...
```
New-MgRoleManagementEntitlementManagementRoleAssignmentRequest
 -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUnifiedRoleAssignmentRequest
