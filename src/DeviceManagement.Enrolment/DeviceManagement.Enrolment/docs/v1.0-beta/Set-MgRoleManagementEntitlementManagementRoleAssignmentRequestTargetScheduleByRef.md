...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentrequesttargetschedulebyref
schema: 2.0.0
---

# Set-MgRoleManagementEntitlementManagementRoleAssignmentRequestTargetScheduleByRef
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentRequestTargetScheduleByRef
 -UnifiedRoleAssignmentRequestId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentRequestTargetScheduleByRef
 -UnifiedRoleAssignmentRequestId <String> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentRequestTargetScheduleByRef
 -InputObject <IDeviceManagementEnrolmentIdentity> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentRequestTargetScheduleByRef
 -InputObject <IDeviceManagementEnrolmentIdentity> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm]
