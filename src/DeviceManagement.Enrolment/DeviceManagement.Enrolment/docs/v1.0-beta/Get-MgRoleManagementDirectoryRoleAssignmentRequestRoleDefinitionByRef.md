...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestroledefinitionbyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestRoleDefinitionByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestRoleDefinitionByRef -UnifiedRoleAssignmentRequestId <String>
 [<CommonParameters>]
```
