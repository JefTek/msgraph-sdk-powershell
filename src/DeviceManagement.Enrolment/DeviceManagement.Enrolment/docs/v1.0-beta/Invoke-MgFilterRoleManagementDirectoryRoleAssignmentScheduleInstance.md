...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/invoke-mgfilterrolemanagementdirectoryroleassignmentscheduleinstance
schema: 2.0.0
---
...
### Filter (Default)
```
Invoke-MgFilterRoleManagementDirectoryRoleAssignmentScheduleInstance -On <String> [<CommonParameters>]
```
