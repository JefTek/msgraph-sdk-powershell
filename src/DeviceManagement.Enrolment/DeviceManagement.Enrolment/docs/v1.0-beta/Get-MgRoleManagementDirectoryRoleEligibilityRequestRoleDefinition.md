...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleeligibilityrequestroledefinition
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleEligibilityRequestRoleDefinition
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleEligibilityRequestRoleDefinition -UnifiedRoleEligibilityRequestId <String>
