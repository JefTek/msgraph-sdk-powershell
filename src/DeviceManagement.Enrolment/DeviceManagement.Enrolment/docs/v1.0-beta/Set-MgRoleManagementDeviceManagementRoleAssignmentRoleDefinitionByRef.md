...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagementdevicemanagementroleassignmentroledefinitionbyref
schema: 2.0.0
---
...
```
Set-MgRoleManagementDeviceManagementRoleAssignmentRoleDefinitionByRef
 -UnifiedRoleAssignmentMultipleId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm]
...
```
Set-MgRoleManagementDeviceManagementRoleAssignmentRoleDefinitionByRef
 -UnifiedRoleAssignmentMultipleId <String> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
