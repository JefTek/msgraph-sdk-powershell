...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/invoke-mgfilterrolemanagemententitlementmanagementroleassignmentrequest
schema: 2.0.0
---

# Invoke-MgFilterRoleManagementEntitlementManagementRoleAssignmentRequest
...
### Filter (Default)
```
Invoke-MgFilterRoleManagementEntitlementManagementRoleAssignmentRequest -On <String> [<CommonParameters>]
```
