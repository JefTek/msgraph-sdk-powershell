...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagemententitlementmanagementroleassignmentscheduleinstanceactivatedusingbyref
schema: 2.0.0
---
...
```
Get-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstanceActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleInstanceId <String> [<CommonParameters>]
```
