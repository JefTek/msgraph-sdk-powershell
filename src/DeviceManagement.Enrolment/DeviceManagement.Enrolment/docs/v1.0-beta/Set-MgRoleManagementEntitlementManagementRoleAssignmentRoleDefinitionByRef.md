...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentroledefinitionbyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentRoleDefinitionByRef -UnifiedRoleAssignmentId <String>
