...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagementdirectoryroleassignmentrequestroledefinitionbyref
schema: 2.0.0
---

# Set-MgRoleManagementDirectoryRoleAssignmentRequestRoleDefinitionByRef
...
### SetExpanded (Default)
```
Set-MgRoleManagementDirectoryRoleAssignmentRequestRoleDefinitionByRef -UnifiedRoleAssignmentRequestId <String>
