...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagemententitlementmanagementroleeligibilityrequest
schema: 2.0.0
---

# Get-MgRoleManagementEntitlementManagementRoleEligibilityRequest
...
### List (Default)
```
Get-MgRoleManagementEntitlementManagementRoleEligibilityRequest [-ExpandProperty <String[]>]
...
### Get
```
Get-MgRoleManagementEntitlementManagementRoleEligibilityRequest -UnifiedRoleEligibilityRequestId <String>
