...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/stop-mgrolemanagemententitlementmanagementroleassignmentrequest
schema: 2.0.0
---

# Stop-MgRoleManagementEntitlementManagementRoleAssignmentRequest
...
### Cancel (Default)
```
Stop-MgRoleManagementEntitlementManagementRoleAssignmentRequest -UnifiedRoleAssignmentRequestId <String>
...
```
Stop-MgRoleManagementEntitlementManagementRoleAssignmentRequest
 -InputObject <IDeviceManagementEnrolmentIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
