...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgdevicemanagementwindowfeatureupdateprofileassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementWindowFeatureUpdateProfileAssignment -WindowsFeatureUpdateProfileId <String>
...
### Get
```
Get-MgDeviceManagementWindowFeatureUpdateProfileAssignment -WindowsFeatureUpdateProfileAssignmentId <String>
 -WindowsFeatureUpdateProfileId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementWindowFeatureUpdateProfileAssignment -InputObject <IDeviceManagementEnrolmentIdentity>
