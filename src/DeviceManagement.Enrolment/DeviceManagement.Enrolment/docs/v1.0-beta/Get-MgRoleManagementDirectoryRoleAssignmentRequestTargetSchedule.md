...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequesttargetschedule
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestTargetSchedule
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestTargetSchedule -UnifiedRoleAssignmentRequestId <String>
