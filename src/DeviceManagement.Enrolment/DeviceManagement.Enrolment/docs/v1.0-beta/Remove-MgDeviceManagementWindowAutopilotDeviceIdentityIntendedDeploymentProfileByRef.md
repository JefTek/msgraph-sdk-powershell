...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgdevicemanagementwindowautopilotdeviceidentityintendeddeploymentprofilebyref
schema: 2.0.0
---
...
```
Remove-MgDeviceManagementWindowAutopilotDeviceIdentityIntendedDeploymentProfileByRef
 -WindowsAutopilotDeviceIdentityId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
