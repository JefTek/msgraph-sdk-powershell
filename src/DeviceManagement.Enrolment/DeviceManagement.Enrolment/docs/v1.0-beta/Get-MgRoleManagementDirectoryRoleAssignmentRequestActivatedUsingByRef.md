...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestactivatedusingbyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestActivatedUsingByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestActivatedUsingByRef -UnifiedRoleAssignmentRequestId <String>
 [<CommonParameters>]
```
