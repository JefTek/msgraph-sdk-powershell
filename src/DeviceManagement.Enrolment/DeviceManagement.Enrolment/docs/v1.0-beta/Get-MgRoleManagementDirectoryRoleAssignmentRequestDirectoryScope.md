...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestdirectoryscope
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestDirectoryScope
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestDirectoryScope -UnifiedRoleAssignmentRequestId <String>
