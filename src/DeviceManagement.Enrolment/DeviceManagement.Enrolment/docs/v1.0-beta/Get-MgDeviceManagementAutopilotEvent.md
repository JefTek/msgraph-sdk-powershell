...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgdevicemanagementautopilotevent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementAutopilotEvent [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### Get
```
Get-MgDeviceManagementAutopilotEvent -DeviceManagementAutopilotEventId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementAutopilotEvent -InputObject <IDeviceManagementEnrolmentIdentity>
