...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleeligibilityrequesttargetschedule
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleEligibilityRequestTargetSchedule
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleEligibilityRequestTargetSchedule -UnifiedRoleEligibilityRequestId <String>
