...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestactivatedusing
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestActivatedUsing
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestActivatedUsing -UnifiedRoleAssignmentRequestId <String>
