...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentscheduleinstanceactivatedusingbyref
schema: 2.0.0
---
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstanceActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleInstanceId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm]
...
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstanceActivatedUsingByRef
 -UnifiedRoleAssignmentScheduleInstanceId <String> -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
