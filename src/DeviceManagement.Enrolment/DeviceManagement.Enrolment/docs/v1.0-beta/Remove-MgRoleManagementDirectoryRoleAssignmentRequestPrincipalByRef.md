...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectoryroleassignmentrequestprincipalbyref
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryRoleAssignmentRequestPrincipalByRef
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryRoleAssignmentRequestPrincipalByRef -UnifiedRoleAssignmentRequestId <String>
