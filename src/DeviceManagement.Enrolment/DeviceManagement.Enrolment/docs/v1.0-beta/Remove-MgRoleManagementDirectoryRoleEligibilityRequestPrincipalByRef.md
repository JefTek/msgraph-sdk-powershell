...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectoryroleeligibilityrequestprincipalbyref
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryRoleEligibilityRequestPrincipalByRef
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryRoleEligibilityRequestPrincipalByRef -UnifiedRoleEligibilityRequestId <String>
