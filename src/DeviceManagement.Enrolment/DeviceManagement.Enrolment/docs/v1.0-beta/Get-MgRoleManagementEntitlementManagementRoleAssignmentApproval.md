...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagemententitlementmanagementroleassignmentapproval
schema: 2.0.0
---
...
### List (Default)
```
Get-MgRoleManagementEntitlementManagementRoleAssignmentApproval [-ExpandProperty <String[]>]
...
### Get
```
Get-MgRoleManagementEntitlementManagementRoleAssignmentApproval -ApprovalId <String>
