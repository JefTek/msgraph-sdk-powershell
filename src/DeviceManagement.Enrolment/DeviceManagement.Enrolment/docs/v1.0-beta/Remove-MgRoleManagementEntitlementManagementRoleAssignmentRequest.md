...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagemententitlementmanagementroleassignmentrequest
schema: 2.0.0
---

# Remove-MgRoleManagementEntitlementManagementRoleAssignmentRequest
...
### Delete (Default)
```
Remove-MgRoleManagementEntitlementManagementRoleAssignmentRequest -UnifiedRoleAssignmentRequestId <String>
