...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdevicemanagementresourcenamespaceresourceaction
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgRoleManagementDeviceManagementResourceNamespaceResourceAction -UnifiedRbacResourceActionId <String>
 -UnifiedRbacResourceNamespaceId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
