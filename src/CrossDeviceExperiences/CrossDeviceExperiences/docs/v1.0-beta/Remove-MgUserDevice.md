...
### Delete (Default)
```
Remove-MgUserDevice -DeviceId <String> -UserId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserDevice -InputObject <ICrossDeviceExperiencesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
