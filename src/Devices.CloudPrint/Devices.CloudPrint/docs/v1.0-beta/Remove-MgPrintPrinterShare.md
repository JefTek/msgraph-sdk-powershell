...
### Delete (Default)
```
Remove-MgPrintPrinterShare -PrinterShareId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPrintPrinterShare -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>] [-PassThru]
