...
### Reset (Default)
```
Reset-MgPrintPrinterSharePrinterDefault -PrinterShareId <String> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgPrintPrinterSharePrinterDefault -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-Confirm]
