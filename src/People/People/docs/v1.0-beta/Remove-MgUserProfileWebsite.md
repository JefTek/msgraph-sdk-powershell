...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mguserprofilewebsite
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgUserProfileWebsite -PersonWebsiteId <String> -UserId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserProfileWebsite -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
