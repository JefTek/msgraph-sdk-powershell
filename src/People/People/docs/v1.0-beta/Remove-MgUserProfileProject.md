...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mguserprofileproject
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgUserProfileProject -ProjectParticipationId <String> -UserId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserProfileProject -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
