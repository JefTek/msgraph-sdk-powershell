...
### Create
```
New-MgUserProfileName -UserId <String> -BodyParameter <IMicrosoftGraphPersonName> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserProfileName -InputObject <IPeopleIdentity> -BodyParameter <IMicrosoftGraphPersonName> [-Confirm]
