...
### Get (Default)
```
Get-MgUserSharedResourceInsightByRef -SharedInsightId <String> -UserId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserSharedResourceInsightByRef -InputObject <IPeopleIdentity> [<CommonParameters>]
```
