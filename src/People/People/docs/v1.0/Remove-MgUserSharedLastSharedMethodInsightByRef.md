...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mgusersharedlastsharedmethodinsightbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgUserSharedLastSharedMethodInsightByRef -SharedInsightId <String> -UserId <String> [-IfMatch <String>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserSharedLastSharedMethodInsightByRef -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru]
