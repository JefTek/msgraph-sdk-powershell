...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/set-mgusersharedresourceinsightbyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgUserSharedResourceInsightByRef -SharedInsightId <String> -UserId <String>
 [-AdditionalProperties <Hashtable>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Set
```
Set-MgUserSharedResourceInsightByRef -SharedInsightId <String> -UserId <String> -BodyParameter <Hashtable>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgUserSharedResourceInsightByRef -InputObject <IPeopleIdentity> -BodyParameter <Hashtable> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-MgUserSharedResourceInsightByRef -InputObject <IPeopleIdentity> [-AdditionalProperties <Hashtable>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
