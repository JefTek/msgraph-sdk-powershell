...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/remove-mguserusedresourceinsightbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgUserUsedResourceInsightByRef -UsedInsightId <String> -UserId <String> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgUserUsedResourceInsightByRef -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
