...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.people/get-mgusersharedlastsharedmethodinsightbyref
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgUserSharedLastSharedMethodInsightByRef -SharedInsightId <String> -UserId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserSharedLastSharedMethodInsightByRef -InputObject <IPeopleIdentity> [<CommonParameters>]
```
