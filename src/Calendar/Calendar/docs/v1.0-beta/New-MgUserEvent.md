...
### Create
```
New-MgUserEvent -UserId <String> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
