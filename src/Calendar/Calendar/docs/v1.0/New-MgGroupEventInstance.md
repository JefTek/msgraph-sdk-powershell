...
### Create
```
New-MgGroupEventInstance -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupEventInstance -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
