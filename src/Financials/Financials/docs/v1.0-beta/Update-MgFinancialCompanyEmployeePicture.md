...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanyemployeepicture
schema: 2.0.0
---
...
```
Update-MgFinancialCompanyEmployeePicture -CompanyId <String> -EmployeeId <String> -PictureId <String>
...
### UpdateViaIdentity
```
Update-MgFinancialCompanyEmployeePicture -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
