...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalecreditmemolineitempicture
schema: 2.0.0
---
...
```
Update-MgFinancialCompanySaleCreditMemoLineItemPicture -CompanyId <String> -PictureId <String>
...
```
Update-MgFinancialCompanySaleCreditMemoLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesCreditMemoLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgFinancialCompanySaleCreditMemoLineItemPicture -InputObject <IFinancialsIdentity>
