...
### Create1
```
New-MgFinancialCompanySaleOrderLineItemPicture -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-Confirm] [-WhatIf] [<CommonParameters>]
```
