...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleinvoicecustomerpicture
schema: 2.0.0
---
...
```
Update-MgFinancialCompanySaleInvoiceCustomerPicture -CompanyId <String> -PictureId <String>
...
```
Update-MgFinancialCompanySaleInvoiceCustomerPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgFinancialCompanySaleInvoiceCustomerPicture -InputObject <IFinancialsIdentity>
