...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysaleinvoicepaymentterm
schema: 2.0.0
---
...
```
Update-MgFinancialCompanySaleInvoicePaymentTerm -CompanyId <String> -SalesInvoiceId <String>
...
### UpdateViaIdentity
```
Update-MgFinancialCompanySaleInvoicePaymentTerm -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphPaymentTerm> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
