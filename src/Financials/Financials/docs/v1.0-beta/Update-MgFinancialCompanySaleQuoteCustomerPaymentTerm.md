...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalequotecustomerpaymentterm
schema: 2.0.0
---
...
```
Update-MgFinancialCompanySaleQuoteCustomerPaymentTerm -CompanyId <String> -SalesQuoteId <String>
...
### UpdateViaIdentity
```
Update-MgFinancialCompanySaleQuoteCustomerPaymentTerm -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphPaymentTerm> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
