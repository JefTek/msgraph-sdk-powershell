...
Update-MgFinancialCompanyAgedAccountReceivable -AgedAccountsReceivableId <String> -CompanyId <String>
 ...
 [-PeriodLengthFilter <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgFinancialCompanyAgedAccountReceivable -AgedAccountsReceivableId <String> -CompanyId <String>
 -BodyParameter <IMicrosoftGraphAgedAccountsReceivable> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
