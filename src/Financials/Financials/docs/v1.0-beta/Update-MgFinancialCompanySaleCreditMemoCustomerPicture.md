...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanysalecreditmemocustomerpicture
schema: 2.0.0
---
...
```
Update-MgFinancialCompanySaleCreditMemoCustomerPicture -CompanyId <String> -PictureId <String>
...
```
Update-MgFinancialCompanySaleCreditMemoCustomerPicture -CompanyId <String> -PictureId <String>
 -SalesCreditMemoId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgFinancialCompanySaleCreditMemoCustomerPicture -InputObject <IFinancialsIdentity>
