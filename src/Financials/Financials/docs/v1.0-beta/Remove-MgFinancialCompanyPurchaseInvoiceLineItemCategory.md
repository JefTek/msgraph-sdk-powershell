...
### Delete1
```
Remove-MgFinancialCompanyPurchaseInvoiceLineItemCategory -CompanyId <String> -PurchaseInvoiceId <String>
 -PurchaseInvoiceLineId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgFinancialCompanyPurchaseInvoiceLineItemCategory -InputObject <IFinancialsIdentity>
 [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
