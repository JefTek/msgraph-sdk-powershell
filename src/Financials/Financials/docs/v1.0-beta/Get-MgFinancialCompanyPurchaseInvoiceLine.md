...
### List (Default)
```
Get-MgFinancialCompanyPurchaseInvoiceLine -CompanyId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgFinancialCompanyPurchaseInvoiceLine -InputObject <IFinancialsIdentity> [-ExpandProperty <String[]>]
