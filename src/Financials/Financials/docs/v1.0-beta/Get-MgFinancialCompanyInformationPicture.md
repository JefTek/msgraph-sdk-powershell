...
### Get (Default)
```
Get-MgFinancialCompanyInformationPicture -CompanyId <String> -CompanyInformationId <String> -OutFile <String>
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgFinancialCompanyInformationPicture -InputObject <IFinancialsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
