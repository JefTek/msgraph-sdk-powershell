...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/update-mgfinancialcompanypurchaseinvoicecurrency
schema: 2.0.0
---
...
```
Update-MgFinancialCompanyPurchaseInvoiceCurrency -CompanyId <String> -PurchaseInvoiceId <String>
...
### UpdateViaIdentity
```
Update-MgFinancialCompanyPurchaseInvoiceCurrency -InputObject <IFinancialsIdentity>
 -BodyParameter <IMicrosoftGraphCurrency> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
