...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/new-mgfinancialcompanyaccount
schema: 2.0.0
---

# New-MgFinancialCompanyAccount
...
```
New-MgFinancialCompanyAccount -CompanyId <String> [-AdditionalProperties <Hashtable>] [-Blocked]
 [-Category <String>] [-DisplayName <String>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Number <String>] [-SubCategory <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-MgFinancialCompanyAccount -CompanyId <String> -BodyParameter <IMicrosoftGraphAccount> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgFinancialCompanyAccount -InputObject <IFinancialsIdentity> -BodyParameter <IMicrosoftGraphAccount>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgFinancialCompanyAccount -InputObject <IFinancialsIdentity> [-AdditionalProperties <Hashtable>]
