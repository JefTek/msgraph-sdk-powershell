...
### Update1
```
Update-MgFinancialCompanySaleOrderLineItem -CompanyId <String> -SalesOrderId <String>
 -SalesOrderLineId <String> -BodyParameter <IMicrosoftGraphItem> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
