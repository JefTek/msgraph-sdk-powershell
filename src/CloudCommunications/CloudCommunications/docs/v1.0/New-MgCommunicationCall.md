...
```
New-MgCommunicationCall [-AdditionalProperties <Hashtable>] [-CallbackUri <String>] [-CallChainId <String>]
 [-CallOptions <Hashtable>] [-CallRoutes <IMicrosoftGraphCallRoute[]>] [-ChatInfo <IMicrosoftGraphChatInfo>]
