...
### Set (Default)
```
Set-MgCommunicationOnlineMeetingRecording -OnlineMeetingId <String> -InFile <String> [-BodyParameter <Stream>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgCommunicationOnlineMeetingRecording -InputObject <ICloudCommunicationsIdentity> -InFile <String>
