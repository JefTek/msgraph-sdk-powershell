...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementconditionstatementmanagementconditionstatementexpressionstring
schema: 2.0.0
---
...
```
Get-MgDeviceManagementConditionStatementManagementConditionStatementExpressionString
 -ManagementConditionStatementId <String> [<CommonParameters>]
```
