...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementeffectivepermission49b0
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementEffectivePermission49B0 -Scope <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementEffectivePermission49B0 -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
