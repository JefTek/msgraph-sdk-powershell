...
# Compare-MgDeviceManagementIntent
...
### Compare (Default)
```
Compare-MgDeviceManagementIntent -DeviceManagementIntentId <String> -TemplateId <String> [<CommonParameters>]
```

### CompareViaIdentity
```
Compare-MgDeviceManagementIntent -InputObject <IDeviceManagementFunctionsIdentity> [<CommonParameters>]
```
