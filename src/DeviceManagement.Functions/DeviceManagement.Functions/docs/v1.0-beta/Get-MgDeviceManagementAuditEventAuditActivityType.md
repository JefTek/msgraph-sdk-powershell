...
### Get (Default)
```
Get-MgDeviceManagementAuditEventAuditActivityType -Category <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementAuditEventAuditActivityType -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
