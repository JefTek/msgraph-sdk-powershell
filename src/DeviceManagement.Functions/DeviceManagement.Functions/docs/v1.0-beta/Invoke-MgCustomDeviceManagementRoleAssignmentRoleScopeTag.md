...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/invoke-mgcustomdevicemanagementroleassignmentrolescopetag
schema: 2.0.0
---
...
### Custom (Default)
```
Invoke-MgCustomDeviceManagementRoleAssignmentRoleScopeTag -DeviceAndAppManagementRoleAssignmentId <String>
 [<CommonParameters>]
```

### CustomViaIdentity
```
Invoke-MgCustomDeviceManagementRoleAssignmentRoleScopeTag -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
...
Parameter Sets: CustomViaIdentity
Aliases:
