...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementscriptdevicerunstatemanageddevicenoncompliantsetting
schema: 2.0.0
---
...
```
Get-MgDeviceManagementScriptDeviceRunStateManagedDeviceNonCompliantSetting
 -DeviceManagementScriptDeviceStateId <String> -DeviceManagementScriptId <String> [<CommonParameters>]
```
