...
### Compare (Default)
```
Compare-MgDeviceManagementTemplate -DeviceManagementTemplateId <String> -TemplateId <String>
 [<CommonParameters>]
```

### CompareViaIdentity
```
Compare-MgDeviceManagementTemplate -InputObject <IDeviceManagementFunctionsIdentity> [<CommonParameters>]
```
