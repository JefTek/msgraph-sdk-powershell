...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementconditionforplatform
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementConditionForPlatform -Platform <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementConditionForPlatform -InputObject <IDeviceManagementFunctionsIdentity>
 [<CommonParameters>]
```
