...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.functions/get-mgdevicemanagementconditionstatementmanagementconditionforplatform
schema: 2.0.0
---
...
```
Get-MgDeviceManagementConditionStatementManagementConditionForPlatform
 -ManagementConditionStatementId <String> -Platform <String> [<CommonParameters>]
```
