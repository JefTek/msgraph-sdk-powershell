...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementmanageddevicesecuritybaselinestate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementManagedDeviceSecurityBaselineState -ManagedDeviceId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementManagedDeviceSecurityBaselineState -InputObject <IDeviceManagementIdentity>
