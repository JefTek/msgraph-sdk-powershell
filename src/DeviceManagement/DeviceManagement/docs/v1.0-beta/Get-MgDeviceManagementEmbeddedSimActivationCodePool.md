...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementembeddedsimactivationcodepool
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementEmbeddedSimActivationCodePool [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDeviceManagementEmbeddedSimActivationCodePool -EmbeddedSimActivationCodePoolId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgDeviceManagementEmbeddedSimActivationCodePool -InputObject <IDeviceManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
