...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementuserexperienceanalyticimpactingprocess
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementUserExperienceAnalyticImpactingProcess [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceManagementUserExperienceAnalyticImpactingProcess -InputObject <IDeviceManagementIdentity>
...
key: id of userExperienceAnalyticsImpactingProcess
