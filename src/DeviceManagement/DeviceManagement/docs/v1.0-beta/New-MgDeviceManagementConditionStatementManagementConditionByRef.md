...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementconditionstatementmanagementconditionbyref
schema: 2.0.0
---
...
```
New-MgDeviceManagementConditionStatementManagementConditionByRef -ManagementConditionStatementId <String>
...
### CreateViaIdentity
```
New-MgDeviceManagementConditionStatementManagementConditionByRef -InputObject <IDeviceManagementIdentity>
 -BodyParameter <Hashtable> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IPathsZrumq9DevicemanagementManagementconditionstatementsManagementconditionstatementIdManagementconditionsRefPostResponses201ContentApplicationJsonSchema
