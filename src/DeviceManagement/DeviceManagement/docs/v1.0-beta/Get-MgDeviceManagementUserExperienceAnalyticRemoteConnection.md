...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementuserexperienceanalyticremoteconnection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementUserExperienceAnalyticRemoteConnection [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDeviceManagementUserExperienceAnalyticRemoteConnection -InputObject <IDeviceManagementIdentity>
