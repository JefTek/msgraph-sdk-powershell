...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/set-mgdevicemanagementdeviceshellscriptrunsummarybyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgDeviceManagementDeviceShellScriptRunSummaryByRef -DeviceShellScriptId <String>
...
### SetViaIdentity
```
Set-MgDeviceManagementDeviceShellScriptRunSummaryByRef -InputObject <IDeviceManagementIdentity>
 -BodyParameter <Hashtable> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
