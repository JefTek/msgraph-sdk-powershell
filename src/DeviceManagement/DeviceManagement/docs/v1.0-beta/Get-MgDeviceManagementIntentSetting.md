...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementintentsetting
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementIntentSetting -DeviceManagementIntentId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgDeviceManagementIntentSetting -DeviceManagementIntentId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementIntentSetting -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
