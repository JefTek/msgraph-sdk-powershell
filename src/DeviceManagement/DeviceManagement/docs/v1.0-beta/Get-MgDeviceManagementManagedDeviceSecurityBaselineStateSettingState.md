...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementmanageddevicesecuritybaselinestatesettingstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementManagedDeviceSecurityBaselineStateSettingState -ManagedDeviceId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementManagedDeviceSecurityBaselineStateSettingState -InputObject <IDeviceManagementIdentity>
