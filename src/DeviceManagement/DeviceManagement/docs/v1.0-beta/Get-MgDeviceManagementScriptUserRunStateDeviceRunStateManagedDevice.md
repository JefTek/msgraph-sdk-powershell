...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementscriptuserrunstatedevicerunstatemanageddevice
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgDeviceManagementScriptUserRunStateDeviceRunStateManagedDevice -InputObject <IDeviceManagementIdentity>
