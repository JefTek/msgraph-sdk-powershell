...
### List (Default)
```
Get-MgDeviceManagementEmbeddedSimActivationCodePoolAssignment -EmbeddedSimActivationCodePoolId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementEmbeddedSimActivationCodePoolAssignment -InputObject <IDeviceManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
