...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementintentcategory
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementIntentCategory -DeviceManagementIntentId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgDeviceManagementIntentCategory -DeviceManagementIntentId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementIntentCategory -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
