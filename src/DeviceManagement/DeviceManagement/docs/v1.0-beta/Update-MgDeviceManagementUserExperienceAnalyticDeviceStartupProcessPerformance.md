...
Update-MgDeviceManagementUserExperienceAnalyticDeviceStartupProcessPerformance
 ...
 [-ProductName <String>] [-Publisher <String>] [-TotalImpactInMS <Int32>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementUserExperienceAnalyticDeviceStartupProcessPerformance
 ...
 [-Publisher <String>] [-TotalImpactInMS <Int32>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
