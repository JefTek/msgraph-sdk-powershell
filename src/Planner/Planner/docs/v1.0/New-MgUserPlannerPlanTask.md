...
### Create1
```
New-MgUserPlannerPlanTask -PlannerPlanId <String> -UserId <String> -BodyParameter <IMicrosoftGraphPlannerTask>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgUserPlannerPlanTask -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerTask>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
