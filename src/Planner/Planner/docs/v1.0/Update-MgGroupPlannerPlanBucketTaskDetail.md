...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mggroupplannerplanbuckettaskdetail
schema: 2.0.0
---
...
Update-MgGroupPlannerPlanBucketTaskDetail -GroupId <String> -PlannerBucketId <String> -PlannerPlanId <String>
 ...
 [-Id <String>] [-PreviewType <String>] [-References <Hashtable>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
