...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/new-mgplannerplanbuckettask
schema: 2.0.0
---

# New-MgPlannerPlanBucketTask
...
```
New-MgPlannerPlanBucketTask -InputObject <IPlannerIdentity> [-ActiveChecklistItemCount <Int32>]
