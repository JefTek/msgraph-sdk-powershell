...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mggroupplannerplantask
schema: 2.0.0
---

# Update-MgGroupPlannerPlanTask
...
```
Update-MgGroupPlannerPlanTask -GroupId <String> -PlannerPlanId <String> -PlannerTaskId <String>
...
### UpdateViaIdentity1
```
Update-MgGroupPlannerPlanTask -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerTask1>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupPlannerPlanTask -InputObject <IPlannerIdentity> [-ActiveChecklistItemCount <Int32>]
