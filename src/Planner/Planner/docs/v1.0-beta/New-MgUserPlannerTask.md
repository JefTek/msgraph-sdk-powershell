...
### Create
```
New-MgUserPlannerTask -UserId <String> -BodyParameter <IMicrosoftGraphPlannerTask1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgUserPlannerTask -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerTask1> [-WhatIf]
