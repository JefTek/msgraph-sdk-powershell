...
### Create
```
New-MgUserPlannerTask -UserId <String> -BodyParameter <IMicrosoftGraphPlannerTask1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgUserPlannerTask -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerTask1> [-Confirm]
