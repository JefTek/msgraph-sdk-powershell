...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mgplannerplantaskdetail
schema: 2.0.0
---
...
```
Update-MgPlannerPlanTaskDetail -PlannerPlanId <String> -PlannerTaskId <String>
...
### UpdateViaIdentity
```
Update-MgPlannerPlanTaskDetail -InputObject <IPlannerIdentity>
 -BodyParameter <IMicrosoftGraphPlannerTaskDetails1> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgPlannerPlanTaskDetail -InputObject <IPlannerIdentity> [-AdditionalProperties <Hashtable>]
