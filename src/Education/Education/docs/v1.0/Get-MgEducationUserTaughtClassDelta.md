...
### Delta1 (Default)
```
Get-MgEducationUserTaughtClassDelta -EducationUserId <String> [<CommonParameters>]
```

### DeltaViaIdentity1
```
Get-MgEducationUserTaughtClassDelta -InputObject <IEducationIdentity> [<CommonParameters>]
```
