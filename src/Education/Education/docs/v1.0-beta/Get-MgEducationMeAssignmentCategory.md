...
### Get
```
Get-MgEducationMeAssignmentCategory -EducationAssignmentId <String> -EducationCategoryId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgEducationMeAssignmentCategory -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]
