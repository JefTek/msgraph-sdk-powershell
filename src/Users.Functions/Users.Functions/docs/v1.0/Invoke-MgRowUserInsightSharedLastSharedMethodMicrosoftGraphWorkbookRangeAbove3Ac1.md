...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsightsharedlastsharedmethodmicrosoftgraphworkbookrangeabove3ac1
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRangeAbove3Ac1 -SharedInsightId <String>
