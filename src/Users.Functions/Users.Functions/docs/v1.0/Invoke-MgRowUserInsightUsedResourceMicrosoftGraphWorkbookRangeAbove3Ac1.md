...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsightusedresourcemicrosoftgraphworkbookrangeabove3ac1
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeAbove3Ac1 -UsedInsightId <String>
 -UserId <String> [<CommonParameters>]
```

### RowsViaIdentity
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeAbove3Ac1 -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
