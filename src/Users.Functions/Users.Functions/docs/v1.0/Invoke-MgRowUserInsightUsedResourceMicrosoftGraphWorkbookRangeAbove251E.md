...
### Rows (Default)
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeAbove251E -Count <Int32> -UsedInsightId <String>
 -UserId <String> [<CommonParameters>]
```

### RowsViaIdentity
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeAbove251E -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
