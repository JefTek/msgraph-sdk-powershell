...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsightusedresourcemicrosoftgraphworkbookrangebelowcb11
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeBelowCb11 -Count <Int32> -UsedInsightId <String>
 -UserId <String> [<CommonParameters>]
```

### RowsViaIdentity
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeBelowCb11 -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
