...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mglastuserinsightusedresourcemicrosoftgraphworkbookrangecell
schema: 2.0.0
---
...
### Last (Default)
```
Invoke-MgLastUserInsightUsedResourceMicrosoftGraphWorkbookRangeCell -UsedInsightId <String> -UserId <String>
 [<CommonParameters>]
```

### LastViaIdentity
```
Invoke-MgLastUserInsightUsedResourceMicrosoftGraphWorkbookRangeCell -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
