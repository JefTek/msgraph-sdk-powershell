...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgoffsetuserinsightsharedlastsharedmethodmicrosoftgraphworkbookrange
schema: 2.0.0
---
...
### Offset (Default)
```
Invoke-MgOffsetUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRange -ColumnOffset <Int32>
 -RowOffset <Int32> -SharedInsightId <String> -UserId <String> [<CommonParameters>]
```
