...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsightsharedlastsharedmethodmicrosoftgraphworkbookrangebelow3b3c
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRangeBelow3B3C -SharedInsightId <String>
