...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgentireuserinsightsharedlastsharedmethodmicrosoftgraphworkbookrangecolumn
schema: 2.0.0
---
...
### Entire (Default)
```
Invoke-MgEntireUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRangeColumn -SharedInsightId <String>
