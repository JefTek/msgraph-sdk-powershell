...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgviewuserinsighttrendingresourcemicrosoftgraphworkbookrangevisible
schema: 2.0.0
---
...
### View (Default)
```
Invoke-MgViewUserInsightTrendingResourceMicrosoftGraphWorkbookRangeVisible -TrendingId <String>
