...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrangeuserinsightusedresourcemicrosoftgraphworkbookrange
schema: 2.0.0
---
...
### Range (Default)
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRange -UsedInsightId <String> -UserId <String>
 [<CommonParameters>]
```
...
### RangeViaIdentity
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRange -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
