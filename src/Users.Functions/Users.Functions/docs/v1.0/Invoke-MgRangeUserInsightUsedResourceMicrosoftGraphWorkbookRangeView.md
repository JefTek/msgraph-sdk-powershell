...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrangeuserinsightusedresourcemicrosoftgraphworkbookrangeview
schema: 2.0.0
---
...
### Range (Default)
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRangeView -UsedInsightId <String> -UserId <String>
 [<CommonParameters>]
```

### RangeViaIdentity
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRangeView -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
