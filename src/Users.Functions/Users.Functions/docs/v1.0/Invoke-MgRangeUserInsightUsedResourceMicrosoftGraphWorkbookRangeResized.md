...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrangeuserinsightusedresourcemicrosoftgraphworkbookrangeresized
schema: 2.0.0
---
...
### Range (Default)
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRangeResized -DeltaColumns <Int32>
 -DeltaRows <Int32> -UsedInsightId <String> -UserId <String> [<CommonParameters>]
```

### RangeViaIdentity
```
Invoke-MgRangeUserInsightUsedResourceMicrosoftGraphWorkbookRangeResized -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
