...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrangeuserinsightsharedlastsharedmethodmicrosoftgraphworkbookrangeview
schema: 2.0.0
---
...
### Range (Default)
```
Invoke-MgRangeUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRangeView -SharedInsightId <String>
