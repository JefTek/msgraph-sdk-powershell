...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsightusedresourcemicrosoftgraphworkbookrangeentire
schema: 2.0.0
---
...
### Row (Default)
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeEntire -UsedInsightId <String> -UserId <String>
 [<CommonParameters>]
```

### RowViaIdentity
```
Invoke-MgRowUserInsightUsedResourceMicrosoftGraphWorkbookRangeEntire -InputObject <IUsersFunctionsIdentity>
 [<CommonParameters>]
```
