...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsighttrendingresourcemicrosoftgraphworkbookrangebelow3b3c
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightTrendingResourceMicrosoftGraphWorkbookRangeBelow3B3C -TrendingId <String>
