...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsighttrendingresourcemicrosoftgraphworkbookrangeabove3ac1
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightTrendingResourceMicrosoftGraphWorkbookRangeAbove3Ac1 -TrendingId <String>
