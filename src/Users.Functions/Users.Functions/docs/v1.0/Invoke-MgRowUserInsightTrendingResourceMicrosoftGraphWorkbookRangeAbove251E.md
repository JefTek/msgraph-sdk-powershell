...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgrowuserinsighttrendingresourcemicrosoftgraphworkbookrangeabove251e
schema: 2.0.0
---
...
### Rows (Default)
```
Invoke-MgRowUserInsightTrendingResourceMicrosoftGraphWorkbookRangeAbove251E -Count <Int32>
