...
### Get (Default)
```
Get-MgUserManagedDeviceNonCompliantSetting -ManagedDeviceId <String> -UserId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserManagedDeviceNonCompliantSetting -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
