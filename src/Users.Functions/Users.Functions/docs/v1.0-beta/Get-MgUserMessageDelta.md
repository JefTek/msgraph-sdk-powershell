...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/get-mgusermessagedelta
schema: 2.0.0
---
...
### Delta1 (Default)
```
Get-MgUserMessageDelta -UserId <String> [<CommonParameters>]
```

### DeltaViaIdentity1
```
Get-MgUserMessageDelta -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
