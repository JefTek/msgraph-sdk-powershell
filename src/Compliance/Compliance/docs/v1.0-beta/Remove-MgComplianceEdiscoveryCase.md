...
### Delete (Default)
```
Remove-MgComplianceEdiscoveryCase -CaseId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-IfMatch <String>] [-PassThru]
