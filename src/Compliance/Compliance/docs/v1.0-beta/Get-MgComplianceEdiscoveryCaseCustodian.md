...
### List (Default)
```
Get-MgComplianceEdiscoveryCaseCustodian -CaseId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Get
```
Get-MgComplianceEdiscoveryCaseCustodian -CaseId <String> -CustodianId <String> [-ExpandProperty <String[]>]
