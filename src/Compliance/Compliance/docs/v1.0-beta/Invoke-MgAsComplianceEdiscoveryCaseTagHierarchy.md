...
### As (Default)
```
Invoke-MgAsComplianceEdiscoveryCaseTagHierarchy -CaseId <String> [<CommonParameters>]
```

### AsViaIdentity
```
Invoke-MgAsComplianceEdiscoveryCaseTagHierarchy -InputObject <IComplianceIdentity> [<CommonParameters>]
```
