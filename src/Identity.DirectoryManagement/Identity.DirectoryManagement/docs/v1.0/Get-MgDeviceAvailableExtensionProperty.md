...
### GetExpanded (Default)
```
Get-MgDeviceAvailableExtensionProperty [-AdditionalProperties <Hashtable>] [-IsSyncedFromOnPremises]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1540TevDevicesMicrosoftGraphGetavailableextensionpropertiesPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
