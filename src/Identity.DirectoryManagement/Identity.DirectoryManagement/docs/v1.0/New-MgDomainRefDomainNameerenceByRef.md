...
```
New-MgDomainRefDomainNameerenceByRef -DomainId <String> [-AdditionalProperties <Hashtable>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create1
```
New-MgDomainRefDomainNameerenceByRef -DomainId <String> -BodyParameter <Hashtable> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
