...
### List (Default)
```
Get-MgUserOutlookTaskFolderTaskSingleValueExtendedProperty -OutlookTaskFolderId <String>
...
### GetViaIdentity
```
Get-MgUserOutlookTaskFolderTaskSingleValueExtendedProperty -InputObject <IUsersIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
