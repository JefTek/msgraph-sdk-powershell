...
### Get3
```
Get-MgUserPhoto -ProfilePhotoId <String> -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
### List1
```
Get-MgUserPhoto -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
