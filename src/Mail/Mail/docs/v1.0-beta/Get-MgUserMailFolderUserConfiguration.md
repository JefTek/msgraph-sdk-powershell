...
### List (Default)
```
Get-MgUserMailFolderUserConfiguration -MailFolderId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserMailFolderUserConfiguration -InputObject <IMailIdentity> [-ExpandProperty <String[]>]
