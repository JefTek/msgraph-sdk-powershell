...
### List1 (Default)
```
Get-MgUserInferenceClassificationOverride -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgUserInferenceClassificationOverride -InputObject <IMailIdentity> [-ExpandProperty <String[]>]
