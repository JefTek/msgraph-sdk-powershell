...
Update-MgEntitlementManagementAccessPackageAssignment -AccessPackageAssignmentId <String>
 ...
 [-Target <IMicrosoftGraphAccessPackageSubject>] [-TargetId <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```
Update-MgEntitlementManagementAccessPackageAssignment -AccessPackageAssignmentId <String>
 -BodyParameter <IMicrosoftGraphAccessPackageAssignment> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
The resource roles delivered to the target user for this assignment.
Read-only.
Nullable.
...
### -AccessPackageId
The identifier of the access package.
Read-only.
...
### -AssignmentPolicyId
The identifier of the access package assignment policy.
Read-only.
...
### -AssignmentState
The state of the access package assignment.
...
### -CatalogId
The identifier of the catalog containing the access package.
Read-only.
...
### -IsExtended
Indicates whether the access package assignment is extended.
Read-only.
...
### -TargetId
The ID of the subject with the assignment.
Read-only.
