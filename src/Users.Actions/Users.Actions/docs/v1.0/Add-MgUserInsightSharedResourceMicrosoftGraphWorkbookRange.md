...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1NbjkcqUsersUserIdInsightsSharedSharedinsightIdResourceMicrosoftGraphWorkbookrangeMicrosoftGraphInsertPostRequestbodyContentApplicationJsonSchema
