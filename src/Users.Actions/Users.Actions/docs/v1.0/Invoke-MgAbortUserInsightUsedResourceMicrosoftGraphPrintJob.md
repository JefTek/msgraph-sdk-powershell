...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgabortuserinsightusedresourcemicrosoftgraphprintjob
schema: 2.0.0
---
...
```
Invoke-MgAbortUserInsightUsedResourceMicrosoftGraphPrintJob -UsedInsightId <String> -UserId <String>
...
### AbortViaIdentity
```
Invoke-MgAbortUserInsightUsedResourceMicrosoftGraphPrintJob -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1VrtxbuUsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphPrintjobMicrosoftGraphAbortPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1VrtxbuUsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphPrintjobMicrosoftGraphAbortPostRequestbodyContentApplicationJsonSchema
