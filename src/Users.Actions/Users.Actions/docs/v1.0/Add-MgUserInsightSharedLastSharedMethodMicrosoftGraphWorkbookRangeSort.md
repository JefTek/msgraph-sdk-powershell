...
Add-MgUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRangeSort -SharedInsightId <String>
 ...
 [-HasHeaders] [-MatchCase] [-Method <String>] [-Orientation <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1N1Fd80UsersUserIdInsightsSharedSharedinsightIdLastsharedmethodMicrosoftGraphWorkbookrangesortMicrosoftGraphApplyPostRequestbodyContentApplicationJsonSchema
