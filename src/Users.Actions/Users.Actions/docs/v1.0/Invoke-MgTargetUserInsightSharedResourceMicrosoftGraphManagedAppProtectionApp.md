...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsO756IrUsersUserIdInsightsSharedSharedinsightIdResourceMicrosoftGraphManagedappprotectionMicrosoftGraphTargetappsPostRequestbodyContentApplicationJsonSchema
