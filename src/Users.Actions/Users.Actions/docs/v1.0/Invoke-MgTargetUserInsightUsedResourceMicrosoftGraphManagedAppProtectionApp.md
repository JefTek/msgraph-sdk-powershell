...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgtargetuserinsightusedresourcemicrosoftgraphmanagedappprotectionapp
schema: 2.0.0
---
...
```
Invoke-MgTargetUserInsightUsedResourceMicrosoftGraphManagedAppProtectionApp -UsedInsightId <String>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths67HcvyUsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphManagedappprotectionMicrosoftGraphTargetappsPostRequestbodyContentApplicationJsonSchema
