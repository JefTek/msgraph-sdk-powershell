...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/set-mguserinsightusedresourcemicrosoftgraphtargetedmanagedappprotection
schema: 2.0.0
---
...
```
Set-MgUserInsightUsedResourceMicrosoftGraphTargetedManagedAppProtection -UsedInsightId <String>
...
### AssignViaIdentity
```
Set-MgUserInsightUsedResourceMicrosoftGraphTargetedManagedAppProtection -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths121Ojw9UsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths121Ojw9UsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
