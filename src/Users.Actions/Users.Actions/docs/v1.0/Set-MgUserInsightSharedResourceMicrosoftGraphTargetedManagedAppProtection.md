...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/set-mguserinsightsharedresourcemicrosoftgraphtargetedmanagedappprotection
schema: 2.0.0
---
...
```
Set-MgUserInsightSharedResourceMicrosoftGraphTargetedManagedAppProtection -SharedInsightId <String>
...
### AssignViaIdentity
```
Set-MgUserInsightSharedResourceMicrosoftGraphTargetedManagedAppProtection -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsT095LbUsersUserIdInsightsSharedSharedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsT095LbUsersUserIdInsightsSharedSharedinsightIdResourceMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
