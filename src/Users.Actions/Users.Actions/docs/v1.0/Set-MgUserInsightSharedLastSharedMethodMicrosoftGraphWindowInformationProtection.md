...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/set-mguserinsightsharedlastsharedmethodmicrosoftgraphwindowinformationprotection
schema: 2.0.0
---
...
```
Set-MgUserInsightSharedLastSharedMethodMicrosoftGraphWindowInformationProtection -SharedInsightId <String>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Vs9Jh6UsersUserIdInsightsSharedSharedinsightIdLastsharedmethodMicrosoftGraphWindowsinformationprotectionMicrosoftGraphAssignPostRequestbodyContentApplicationJsonSchema
