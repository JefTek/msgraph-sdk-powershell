...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgacceptusermailfoldermessagemicrosoftgrapheventmessagerequest
schema: 2.0.0
---
...
```
Invoke-MgAcceptUserMailFolderMessageMicrosoftGraphEventMessageRequest -MailFolderId <String>
 -MessageId <String> -UserId <String> [-AdditionalProperties <Hashtable>] [-Comment <String>] [-SendResponse]
...
### AcceptViaIdentity
```
Invoke-MgAcceptUserMailFolderMessageMicrosoftGraphEventMessageRequest -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPathsC0T5DtUsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphEventmessagerequestMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsC0T5DtUsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphEventmessagerequestMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema
