...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Xhdcw6UsersUserIdMicrosoftGraphExportpersonaldataPostRequestbodyContentApplicationJsonSchema
...
Parameter Sets: ExportViaIdentity1, ExportViaIdentityExpanded1
Aliases:
